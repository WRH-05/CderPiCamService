...
- The ONNX model (`best_sahl_1.5x_final.onnx`) and its external-data companion
  (`best_sahl_1.5x_final.onnx.data`) placed in `model/` at the project root.
...
|------|---------|-------------|
| `--model_path` | `../../model/best_sahl_1.5x_final.onnx` | Path to `.onnx` file (env: `ONNX_MODEL_PATH`) |
...
| Flag | Default | Description |
|------|---------|-------------|
| `--onnx_model` | `../../model/best_sahl_1.5x_final.onnx` | Path to `.onnx` file |
...
|----------|---------|---------|
| `ONNX_MODEL_PATH` | `inference_mqtt.py` | `../../model/best_sahl_1.5x_final.onnx` |
